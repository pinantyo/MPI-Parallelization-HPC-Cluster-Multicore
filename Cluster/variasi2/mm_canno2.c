...
int main(int argc, char** argv) {
  ...
  float **subm_A = malloc(tam_subM * sizeof(float *));
  for (int i = 0; i < tam_subM; i++) {
      subm_A[i] = malloc(tam_subM * sizeof(float));
  }
  float **subm_B = malloc(tam_subM * sizeof(float *));
  for (int i = 0; i < tam_subM; i++) {
      subm_B[i] = malloc(tam_subM * sizeof(float));
  }
  float **subm_C = malloc(tam_subM * sizeof(float *));
  for (int i = 0; i < tam_subM; i++) {
      subm_C[i] = malloc(tam_subM * sizeof(float));
  }
